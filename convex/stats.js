...
exports.getHealthMetrics = exports.getQueueStatus = exports.getRecentActivity = exports.getSystemStats = void 0;
const server_1 = require("./_generated/server");
const values_1 = require("convex/values");
exports.getSystemStats = (0, server_1.query)({
    args: {},
    handler: async (ctx) => {
        const now = Date.now();
        ...
        const analyzingPackages = allPackages.filter(pkg => pkg.analysis_status === "analyzing" || pkg.analysis_status === "pending");
...
exports.getQueueStatus = (0, server_1.query)({
    args: {},
    handler: async (ctx) => {
...
exports.getHealthMetrics = (0, server_1.query)({
    args: {},
    handler: async (ctx) => {
        const now = Date.now();
        const oneDayAgo = now - (24 * 60 * 60 * 1000);
